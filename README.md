...
- **We want to make it very clear that the intended use case is using Ubuntu 24.04, an Nvidia based graphics card, and ROS2 Humble via our Docker container for the competition. But, we do not put any restrictions on the software that you CAN use in the competition.**
