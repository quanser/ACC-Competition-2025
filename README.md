...
- The [official ride list](https://github.com/quanser/ACC-Competition-2025/blob/stage2/Handbook/official_coordinate_ride_list.txt) is up (and it has been updated)!!!
- The list of ROS_Domain_ID assignments can be found [here](https://github.com/quanser/ACC-Competition-2025/blob/stage2/Software_Guides/FAQ.md#how-can-i-change-my-ros_domain_id).
