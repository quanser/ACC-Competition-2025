...
def setup(initialPosition = [-1.205, -0.83, 0.005], initialOrientation = [0, 0, -44.7]):
    ...
    myYieldSign.spawn_degrees(location=[22.3,-2.7,0], rotation=[0,0,180], scale=[1,1,1], waitForConfirmation=False)
    myYieldSign.spawn_degrees(location=[28.0,2.9,0], rotation=[0,0,0], scale=[1,1,1], waitForConfirmation=False)
